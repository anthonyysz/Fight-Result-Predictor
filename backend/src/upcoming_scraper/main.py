...
def main() -> None:
    ...
    initial_rows = initialize_upcoming_rows()
    ...
    save_upcoming_dataframe(upcoming_df)
    ...
    print(f"upcoming_fights_csv: {UPCOMING_FIGHTS_CSV_PATH}")
    ...
    print(f"fight_rows: {len(upcoming_df)}")
